...
> - [关于数据表的建立](#关于数据库字段建立)
>   - [符号说明](#符号说明)
>   - [项目信息表  `Projects`](#项目信息表  `Projects`)
>   - [项目立项申请表 (`ProjectProposals`)](#项目立项申请表 (`ProjectProposals`))
>   - [项目修改申请表 (`ProjectModifications`)](#项目修改申请表 (`ProjectModifications`))
>   - [项目结项申请表 (ProjectClosures)](#项目结项申请表 (ProjectClosures))
>   - [审批历史表 (ApprovalHistory)](#审批历史表 (ApprovalHistory))
>   - [申请小队表 (ApplicationTeams)](#申请小队表 (ApplicationTeams))
>   - [小队成员表 (TeamMembers)](#小队成员表 (TeamMembers))
>   - [用户表 (Users)](#用户表 (Users))
