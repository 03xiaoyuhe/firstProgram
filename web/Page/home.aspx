...
<head>
    ...
    <meta name="description" content="青岛市哲学与社会科学规划项目信息化管理平台" />
    <meta name="author" content="" />
    <meta name="keywords" content="青岛市 管理平台 社科类" />
    <title>哲学与社会科学规划项目信息化管理平台</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-start">
                            <h1>哲学与社会科学规划项目信息化管理平台</h1>
                            <p class="opacity-75">Some representative placeholder content for the first slide of the carousel.</p>
                            <p><a class="btn btn-lg btn-primary" href="#learm-more">马上登陆 -></a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <h2 class="fw-normal">科研人员</h2>
                    <p>For Scientific Researcher</p>
                    <p>在这里可以进行项目申报、信息修改、结项申请等工作</p>
                    <p><a class="btn btn-secondary disabled" role="button" href="#" aria-disabled="true">登陆 &raquo;</a></p>
                </div>
                <!-- /.col-lg-4 -->
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    ...
                    <%--                    <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
                        <rect class="test-imformation-img" style="background-image: url(img/Home_img/adj.png)" width="100%" height="100%" fill="var(--bs-secondary-color)" />
       
                    </svg>--%>
                    <h2 class="fw-normal">评委入口</h2>
                    <p>For Assessor</p>
                    <p>在这里可以进行项目立项审核评级、项目结项审核评级等功能</p>
                    <p><a class="btn btn-secondary disabled" role="button" href="#" aria-disabled="true">登陆 &raquo;</a></p>
                </div>
                <!-- /.col-lg-4 -->
            </div>
