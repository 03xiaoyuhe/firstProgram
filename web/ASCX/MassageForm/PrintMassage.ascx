<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintMassage.ascx.cs" Inherits="WebForm.ASCX.MassageForm.PrintMassageForm" %>

<%@ Register Src="~/ASCX/MassageForm/MassageBox.ascx" TagName="popMassage" TagPrefix="TpopMassage" %>
